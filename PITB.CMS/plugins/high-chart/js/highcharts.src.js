...
/**
 * UtilityExtensions function to create element with attributes and styles
 * @param {Object} tag
...
/**
 * UtilityExtensions method that sorts an object array and keeping the order of equal items.
...
/**
 * UtilityExtensions method that destroys any SVGElement or VMLElement that are properties on the given object.
...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		init: function (pathAnim) {
			...
			/**
			 * UtilityExtensions for iterating over an array. Parameters are reversed compared to jQuery.
			 * @param {Array} arr
			 * @param {Function} fn
			 */
...
// UtilityExtensions functions. If the HighchartsAdapter is not defined, adapter is an empty object
...
SVGRenderer.prototype = {
	...
	*/
	...
	/**
	 * UtilityExtensions to return the baseline offset and total line height from the font size
	 */
...
Axis.prototype = {
	...
	/**
	 * UtilityExtensions method to translate an axis value to pixel position.
	...
	/*
	 * UtilityExtensions method to translate a pixel position in to an axis value
...
Pointer.prototype = {
	...
	/**
	 * UtilityExtensions to detect whether an element has, or has a parent with, a specific
...
var PieSeries = {
	...
	/**
	 * UtilityExtensions for sorting data labels
	 */
