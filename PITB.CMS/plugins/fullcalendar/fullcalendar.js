...
// UtilityExtensions function. Accepts a moment and an array of the UTC year/month/date/etc values to set.
...
// UtilityExtensions function. Accepts a moment and an array of the local year/month/date/etc values to set.
...
Grid.mixin({
	...
	// UtilityExtensions for generating a CSS string with all the event skin-related properties
...
var View = fc.View = Class.extend({
	...
	// UtilityExtensions for formatting a range. Accepts a range object, formatting string, and optional separator.
	...
	// UtilityExtensions for subclasses.
