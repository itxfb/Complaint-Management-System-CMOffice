...
namespace PITB.CMS
{
    public class Config
    {
        ...
        {
            {"StatusChange", "ClassName::PITB.CMS.Handler.Complaint.StatusHandler__MethodName::ChangeStatus__MethodType::Static"}
        }; 
        ...
        public static string ConnectionString = ConfigurationManager.ConnectionStrings["PITB.CMS"].ConnectionString;
