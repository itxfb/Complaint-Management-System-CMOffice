...
{
    public class RepoDbCampaign : GenericRepository<DbCampaign> 
    {
        private UnitOfWork unitOfWork;
        public RepoDbCampaign(CMSDbContext dbContext, UnitOfWork unit) :base(dbContext)
        {
        ...
        public string GetSingleOrCumulativeCampaignName(string campaignIds)
        {
            ...
            else if (campIds.Count > 1)
            {
                ...
                List<DbPermissionsAssignment> lst = this.unitOfWork.DbPermissionsAssignment.GetListOfPermissionsByTypeTypeIdAndPermissionId((int)Config.PermissionsType.General, 1, (int)Config.GeneralPermissions.CumulativeCampaignName);
