...
{
    public class RepDbPermissionsAssignment : GenericRepository<DbPermissionsAssignment>
    {
        public RepDbPermissionsAssignment(CMSDbContext cmsDbContext = null) : base(cmsDbContext)
        {
