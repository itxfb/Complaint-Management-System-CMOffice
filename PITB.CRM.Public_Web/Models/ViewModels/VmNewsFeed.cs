...
namespace PITB.CRM.Public_Web.Models.ViewModels
{
    ...
    public class ComplaintData
    {
        ...
        {
            get { return Utils.Encrypt(ComplaintId); }
        }

        public Int64 DecryptedComplaintId
        {
            get { return Utils.Decrypt(ComplaintHash); }
        }
        ...
        public string TimeElapsed
        {
            get
            {
                ...
                {
                    return string.Format("{0} ago",Utils.CalculateTurnRoundTime(TimeSpan.FromTicks(diff.Ticks)));
                }
                else
                {
        ...
        public Config.ExternalProvider ExternalProvider
        {
            get
            {
                return (string.IsNullOrEmpty(Provider)
                    ...
                    : Utils.ParseEnum<Config.ExternalProvider>(Provider));
            }
        }
    }
