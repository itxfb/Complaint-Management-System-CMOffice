...
{
    public class SyncMultipleCampaingsController : ApiController
    {
        // GET api/<controller>
        ...
        public SyncModel Get(string id, int appId = 0)
        {
            ...
            if (currAppId == 1)
            {
                syncModel = BlApiHandler.GetSyncModelAgaistMultipleCampaignIdWithUcAndWards(id, currAppId);
            }
            return syncModel;
