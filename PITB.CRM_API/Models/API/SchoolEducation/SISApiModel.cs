...
namespace PITB.CRM_API.Models.API.SchoolEducation
{
    public class SISApiModel
    {
        ...
        public class Response
        {
            ...
            public class SISGetUsers: ApiStatus 
            {
                ...
                public SISGetUsers(List<PITB.CMS.Models.DB.DbUsers> listDbUsers, ApiStatus apiStatus)
                {
                    ...
                    if (listDbUsers != null)
                    {
                        ...
                        foreach (PITB.CMS.Models.DB.DbUsers  dbUser in listDbUsers)
                        {
                ...
                public class User
                {
                    ...
                    public class UserCategory
                    {
                        ...
                        public UserCategory(PITB.CMS.Models.DB.DbUserCategory dbUserCategory)
                        {
                    ...
                    public User(PITB.CMS.Models.DB.DbUsers dbUser)
                    {
                        string infoStr = "";
                        ...
                        infoStr = infoStr +
                                  CMS.Utility.GetHierarchyValueName((CMS.Config.Hierarchy) dbUser.Hierarchy_Id,
                                      CMS.Utility.GetIntByCommaSepStr(
                                          (PITB.CMS.Models.DB.DbUsers.GetHierarchyIdValueAgainstHierarchyId(dbUser))));
                        PhoneNo = dbUser.Phone.Trim();
                        Name = dbUser.Name.Trim();
                        Designation = dbUser.Designation;


                        List<PITB.CMS.Models.DB.DbCrmIdsMappingToOtherSystem> listDbCrmIdsMappingToOtherSystems =
                            PITB.CMS.Models.DB.DbCrmIdsMappingToOtherSystem.Get((int)PITB.CMS.Config.CrmModule.Hierarchy, 1,
                     (int)PITB.CMS.Config.OtherSystemId.SchoolEducation, (int)PITB.CMS.Config.CrmModule.Hierarchy, PITB.CMS.Utility.GetNullableIntList(dbUser.Province_Id));
                        ProvinceId =
                            PITB.CMS.Utility.GetCommaSepStrFromList(
                                listDbCrmIdsMappingToOtherSystems.Select(n => n.OTS_Id).ToList());// dbUser.Province_Id;

                        
                        listDbCrmIdsMappingToOtherSystems =
                            PITB.CMS.Models.DB.DbCrmIdsMappingToOtherSystem.Get((int)PITB.CMS.Config.CrmModule.Hierarchy, 2,
                     (int)PITB.CMS.Config.OtherSystemId.SchoolEducation, (int)PITB.CMS.Config.CrmModule.Hierarchy, PITB.CMS.Utility.GetNullableIntList(dbUser.Division_Id));
                        DivisionId = PITB.CMS.Utility.GetCommaSepStrFromList(
                                listDbCrmIdsMappingToOtherSystems.Select(n => n.OTS_Id).ToList()); //dbUser.Division_Id;


                        listDbCrmIdsMappingToOtherSystems =
                            PITB.CMS.Models.DB.DbCrmIdsMappingToOtherSystem.Get((int)PITB.CMS.Config.CrmModule.Hierarchy, 3,
                     (int)PITB.CMS.Config.OtherSystemId.SchoolEducation, (int)PITB.CMS.Config.CrmModule.Hierarchy, PITB.CMS.Utility.GetNullableIntList(dbUser.District_Id));
                        DistrictId = PITB.CMS.Utility.GetCommaSepStrFromList(
                                listDbCrmIdsMappingToOtherSystems.Select(n => n.OTS_Id).ToList());//User.District_Id;


                        listDbCrmIdsMappingToOtherSystems =
                            PITB.CMS.Models.DB.DbCrmIdsMappingToOtherSystem.Get((int)PITB.CMS.Config.CrmModule.Hierarchy, 4,
                     (int)PITB.CMS.Config.OtherSystemId.SchoolEducation, (int)PITB.CMS.Config.CrmModule.Hierarchy, PITB.CMS.Utility.GetNullableIntList(dbUser.Tehsil_Id));
                        TehsilId = PITB.CMS.Utility.GetCommaSepStrFromList(
                                listDbCrmIdsMappingToOtherSystems.Select(n => n.OTS_Id).ToList());//dbUser.Tehsil_Id;

                        listDbCrmIdsMappingToOtherSystems =
                            PITB.CMS.Models.DB.DbCrmIdsMappingToOtherSystem.Get((int)PITB.CMS.Config.CrmModule.Hierarchy, 5,
                     (int)PITB.CMS.Config.OtherSystemId.SchoolEducation, (int)PITB.CMS.Config.CrmModule.Hierarchy, PITB.CMS.Utility.GetNullableIntList(dbUser.UnionCouncil_Id));
                        UcId = PITB.CMS.Utility.GetCommaSepStrFromList(
