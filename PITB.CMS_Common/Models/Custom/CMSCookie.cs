...
namespace PITB.CMS_Common.Models.Custom
{
    public class CMSCookie
    {
        ...
        public Dictionary<string, string> DictCtrlAction { get; set; }

        public dynamic navigationalData { get; set; }
        ...
        public static CMSCookie DbUserToCookie(DbUsers dbUsers)
        {
            ...
            cmsCookie.DictCtrlAction = DbUsers.GetCrlActionsDict(dbUsers);

            cmsCookie.PersonalInfo_Id = dbUsers.PersonalInfo_Id;
            cmsCookie.IsAllowed = dbUsers.IsAllowed;
