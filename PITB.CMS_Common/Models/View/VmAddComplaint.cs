...
using Foolproof;
using PITB.CMS_Common.ApiModels;
...
namespace PITB.CMS_Common.Models.View
{
    public class VmAddComplaint 
    {
        ...
        public const string TabComplaintCombined = "Complaint شکایت";
        public const string TabSuggestionCombined = "Suggestion تجاویز";
        public const string TabInquiryCombined = "Inquiry تفتیش";
        public const string TabInquiryVmCombined = "Inquiry تفتیش";
