...
namespace PITB.CMS_Common.Helper.Database
{
    public static class DBExtensions
    {
        ...
        /// <summary>
        /// Converts dataset to list<T> dynamically
        /// </summary>
                                     ...
                                     propertyInfos.PropertyType == typeof(string))
                            {
                                ...
                                else
                                {
                                    propertyInfos.SetValue
                                     ...
                                     propertyInfos.PropertyType == typeof(bool))
                            {
        ...
        #region Extensions from API Project
        private static double ConvertToDouble(object value)
        {
            return Convert.ToDouble(UtilityExtensions.ReturnZeroIfNull(value));
        }
        #endregion
