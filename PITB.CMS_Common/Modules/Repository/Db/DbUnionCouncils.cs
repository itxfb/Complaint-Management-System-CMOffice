...
namespace PITB.CMS_Common.Models
{
    ...
    //public partial class DbUnionCouncils2
    //{
    //    [Key]
    ...
    public partial class DbUnionCouncils
    {
        ...
        public static IEnumerable<SelectListItem> GetSelectListofUnionCouncilForCampaignAndTehsilIds(int campaignId, string tehsilId)
        {
            try
            {
                ...
                {
                    int groupId = DbHierarchyCampaignGroupMapping.GetGroupIdForCampaignAndHierarchyIds(campaignId, (int)Config.Hierarchy.UnionCouncil);
