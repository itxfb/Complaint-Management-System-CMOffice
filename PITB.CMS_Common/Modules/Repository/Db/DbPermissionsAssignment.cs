...
namespace PITB.CMS_Common.Models
{
    ...
    public partial class DbPermissionsAssignment
    {
        ...
        public static List<DbPermissionsAssignment> GetListOfPermissions(int type, List<int> typeId)
        {
            try
            {
                using (DBContextHelperLinq db = new DBContextHelperLinq())
                {
                    List<DbPermissionsAssignment> listDbPermission = db.DbPermissionsAssignments.AsNoTracking().Where(m => m.Type == type && typeId.Contains((int)m.Type_Id)).ToList();
                    //List<DbPermissionsAssignment> listDbPermission = db.DbPermissionsAssignments.AsNoTracking().ToList();
