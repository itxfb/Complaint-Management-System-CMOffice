...
namespace PITB.CMS_Common.Models
{
    ...
    public partial class DbTehsil
    {
        ...
        public static List<DbTehsil> GetTehsil(int districtId, int campaignId)
        {
        ...
        public static IEnumerable<SelectListItem> GetSelectListofTehsilForCampaignAndDistrictIds(int campaignId, int districtId)
        {
            try
            {
                int groupId = DbHierarchyCampaignGroupMapping.GetGroupIdForCampaignAndHierarchyIds(campaignId, (int)Config.Hierarchy.Tehsil);
