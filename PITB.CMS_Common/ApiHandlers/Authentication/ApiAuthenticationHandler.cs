...
namespace PITB.CMS_Common.ApiHandlers.Authentication
{
        ...
        public static bool IsAuthenticated(AuthenticationModel authenticationModel)
        {
            try
            {
                ...
                if (listAuthenticationModel.FirstOrDefault() != null)
                {
                    ...
                    // Check Scheme
                    List<string> listStr = Utility.Split(listAuthenticationModel.FirstOrDefault().HttpSchemePermission, ",").ToList();
