    ...
    public class BlHealth
    {
        public static HealthResponseModel.SubmitComplaint SubmitComplaint(HealthRequestModel.SubmitComplaint submitComplaintModel, Int64 apiRequestId/*, int appId*/)
        {
            try
            {
                ...
                List<int?> listModuleIds = new List<int?> { (int)Config.CrmModule.CampaignIds, (int)Config.CrmModule.StatusIds };
                List<DbCrmIdsMappingToOtherSystem> listMap = DbCrmIdsMappingToOtherSystem.Get(listModuleIds, (int)Config.OtherSystemId.Health);
                ...
                provinceId = Convert.ToInt32(DbDivision.GetById(divisionId).Province_Id);
                ...
                */
                ...
                paramDict.Add("@Ref_Complaint_Src", Config.OtherSystemId.Health);
        ...
        public static ApiStatus ChangeStatus(DbUsers dbUser, int complaintId, DateTime createdDateTime, int statusId, string statusComments, List<Picture> listPictures, Int64 apiRequestId, bool canSendMessage = false)
        {
            //userId = 31939;
            List<int?> listModuleIds = new List<int?> { (int)Config.CrmModule.StatusIds };
            List<DbCrmIdsMappingToOtherSystem> listMap = DbCrmIdsMappingToOtherSystem.Get(listModuleIds, (int)Config.OtherSystemId.Health);
