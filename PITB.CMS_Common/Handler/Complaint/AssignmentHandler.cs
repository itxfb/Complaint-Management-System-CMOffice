...
namespace PITB.CMS_Common.Handler.Complaint.Assignment
{
    public class AssignmentHandler
    {
        public static List<AssignmentModel> GetAssignmnetModelByCampaignCategorySubCategory(int campaignId, int categoryId, int subCategoryId, bool canPopulateMatrix, int? categoryDep1 = null, int? categoryDep2 = null, string assignmentModelTag = null, float overRideRetainingHours = -1f)
        {
            if (canPopulateMatrix)
            {
                ...
                assignmentModelList = AssignmentHandler.GetAssignmentModel(new FuncParamsModel.Assignment(nowDate,
                    ...
                    catRetainingHours, overRideRetainingHours)/*nowDate,
