...
namespace PITB.CMS_Common.Handler.FileUpload
{
    public class FileUploadHandler
    {

        public static List<DbAttachments> UploadMultipleFiles(HttpFileCollection files, Config.AttachmentReferenceType refType, string complaintIdStr, int imageRefTypeId, string tagId)
        {
        ...
        public static FileValidationStatus GetFileValidationStatus(HttpFileCollection files)
        {
        ...
        public static int GetAttachedFileCount(HttpFileCollection files)
        {
