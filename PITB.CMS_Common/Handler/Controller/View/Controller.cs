...
namespace PITB.CMS_Common.Controllers.View
{
    ...
    public class Controller : System.Web.Mvc.Controller
    {
        ...
        public ActionResult ReturnView(string path, string masterPage = null, object model = null)
        {
            return View(path, masterPage, model);
            //if (model == null)
            //{
            //    return View(path);
            //}
        ...
        public string RedirectionURL(HttpRequestBase request)
        {
