...
namespace PITB.CMS_Common.WindowServiceHandlers
{
    public class SmsHandler
    {
        ...
        public static void SendStatusWiseStatsIndividualCampaign()
        {
            ...
            {
                DbWindowServiceError.SaveErrorLog(1, Environment.StackTrace, ex, Config.ServiceType.SendMsgToDCO);
                //throw;
            }
        ...
        public static void SendStatusWiseStatsCumulativeCampaign()
        {
            ...
            {
                DbWindowServiceError.SaveErrorLog(2, Environment.StackTrace, ex, Config.ServiceType.SendMsgToDCO);
                //throw;
            }
