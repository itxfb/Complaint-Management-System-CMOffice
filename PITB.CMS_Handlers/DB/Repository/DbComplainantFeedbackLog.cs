...
namespace PITB.CMS_Handlers.DB.Repository
{
    ...
    public class RepoDbComplainantFeedbackLog
    {
        ...
        private static void MakeLastLogOfComplaintStatusInactive(int complaintId, DBContextHelperLinq db)
        {
            ...
            DbComplainantFeedbackLog feedbackLog = RepoDbComplainantFeedbackLog.GetLastComplainantFeedbackLogOfParticularComplaint(complaintId, db);
            if (feedbackLog != null)
            {
