...
namespace PITB.CMS_Handlers.Custom
{
    public class PostModel
    {
        public class File
        {
            ...
            public File(HttpFileCollectionBase files)
            {
           ...
           /* public File(List<HttpPostedFileBase> listFileBase)
            ...
            private List<Single> GetListOfFiles(HttpFileCollectionBase fileCollectionBase)
            {
                ...
                {
                    HttpPostedFileBase file = fileCollectionBase[formFileKey];
                    listPostedFile.Add(fileCollectionBase[formFileKey]);
