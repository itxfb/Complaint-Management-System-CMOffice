...
namespace PITB.CMS_Handlers.Custom.Police
{
    public class PoliceModel
    {
        ...
        public class AddComplaint
        {
            ...
            public AddComplaint(CMSCookie cmsCookie, DateTime createdDateTime, Config.SourceType sourceType, VmAddComplaint vmAddComplaint, HttpFileCollectionBase files, NameValueCollection formCollection,
