...
namespace PITB.CMS_Handlers.View.Dynamic
{
    ...
    public class VmDynamicDropDownList : VmDynamicField
    {
        ...
        public VmDynamicDropDownList(int controlId, int controleType, string fieldName, bool isRequired, int priority, List<SelectListItem> fieldValue)
