        ...
        public static dynamic SubmitComplaint(dynamic submitComplaintModel)
        {
            ...
            try
            {
                ...
                new Thread(delegate()
                {
                    ...
                    PITB.CMS_Common.Handler.Messages.TextMessageHandler.SendMessageToPhoneNo(
                        submitComplaintModel.personContactNumber, sms);
                    //PITB.CMS_Common.Handler.Messages.TextMessageHandler.SendMessageOnComplaintLaunch(submitComplaintModel.personContactNumber,
                ...
                //new Thread(delegate()
                //{
                //    PITB.CMS_Common.Handler.Messages.TextMessageHandler.PrepareAndSendMessageToStakeholdersOnComplaintLaunch(
                //        PITB.CMS_Common.Models.DB.DbComplaint.GetByComplaintId(complaintId));
                //}).Start();
