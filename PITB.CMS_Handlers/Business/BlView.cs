...
using Controller = PITB.CMS_Common.Controllers.Controller;
    ...
    public class BlView
    {
        ...
        public ActionResult GetComplaintDetail(int complaintId, string viewType, Controller ctrlRef)
        {
            ...
            if (viewType == "StakeholderComplaintDetail")
            {
                ...
                return ctrlRef.ReturnView("_ComplaintDetail", vmComplaintDetail);
            }
            else if (viewType == "AgentComplaintDetail")
            {
                if (dbComplaint.Compaign_Id == (int) Config.Campaign.Police)
                {
                    ...
                    return ctrlRef.ReturnView("~/Views/Agent/Police/_AgentPoliceDetail.cshtml", vmComplaintPoliceDetail);
                }
                if (dbComplaint.Compaign_Id == (int)Config.Campaign.DcoOffice)
                {
                    ...
                    return ctrlRef.ReturnView("~/Views/Agent/ZimmedarShehri/_AgentZimmedarShehriDetail.cshtml", vmComplaintDetail);
                }
                else
                {
                    VmComplaintDetailAgent vmComplaintDetail =
                        new VmComplaintDetailAgent(BlComplaints.GetComplaintDetail(dbComplaint));
                    return ctrlRef.ReturnView("~/Views/Agent/_AgentDetail.cshtml", vmComplaintDetail);
                }
            }
