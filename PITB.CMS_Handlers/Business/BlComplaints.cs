...
using PITB.CMS_Models.Custom.DataTable;
...
using PITB.CMS_Models.View.Dynamic;
using PITB.CMS_Handlers.DynamicFields;
...
namespace PITB.CMS_Handlers.Business
{
    public class BlComplaints
    {
        public static VmAddComplaint GetVmAddComplaintMerged(VmAddComplaint viewModel, int profileId = 0, int campaignId = 0)
        {
            ...
            viewModel.ComplaintVm.ListOfProvinces = RepoDbProvince.AllProvincesList();

            int? groupId = RepoDbCategoryGroupMapping.GetModelByCampaignIdAndTypeId(campaignId, Config.ComplaintType.Complaint);
            ...
            viewModel.PersonalInfoVm = Mapper.Map<VmPersonalInfo>(RepoDbPersonInformation.GetPersonInformationByPersonId(profileId));
            ...
            groupId = RepoDbCategoryGroupMapping.GetModelByCampaignIdAndTypeId(campaignId, Config.ComplaintType.Suggestion);
            viewModel.SuggestionVm.ListOfDepartment = RepoDbDepartment.GetByCampaignAndGroupId(campaignId, groupId);
            viewModel.SuggestionVm.ListOfComplaintTypes = RepoDbComplaintType.GetByCampaignIdAndGroupId(campaignId, groupId);
            ...
            groupId = RepoDbCategoryGroupMapping.GetModelByCampaignIdAndTypeId(campaignId, Config.ComplaintType.Inquiry);
            viewModel.InquiryVm.ListOfDepartment = RepoDbDepartment.GetByCampaignAndGroupId(campaignId, groupId);
            viewModel.InquiryVm.ListOfComplaintTypes = RepoDbComplaintType.GetByCampaignIdAndGroupId(campaignId, groupId);
        ...
        public static VmComplaintDetail GetComplaintDetail(DbComplaint dbComplaint /*int complaintId*/)
        {
            ...
            List<DbDynamicComplaintFields> listDynamicFields = RepoDbDynamicComplaintFields.GetByComplaintId(dbComplaint.Id/*complaintId*/);
            ...
            DbPersonInformation dbPersonIfo =
                RepoDbPersonInformation.GetPersonInformationByPersonId((int)dbComplaint.Person_Id/*(int)listComplaint.FirstOrDefault().Person_Id)*/);
        ...
        public static VmStakeholderComplaintDetail GetStakeholderComplaintDetail(int complaintId, VmStakeholderComplaintDetail.DetailType detailType)
        {
            List<DbComplaint> listComplaint = DbComplaint.GetListByComplaintId(complaintId);
        ...
        */
        ...
        public static DataTable GetStakeHolderServerSideListDenormalized(string from, string to, DataTableParamsModel dtModel, string commaSeperatedCampaigns, string commaSeperatedCategories, string commaSeperatedStatuses, string commaSeperatedTransferedStatus, int complaintsType, Config.StakeholderComplaintListingType listingType, string spType, int userId = -1)
        {
            ...
            dictParam.Add("@regionValue", RepoDbUsers.GetHierarchyIdValueAgainstHierarchyId(dbUser));
        ...
        public static VmStatusWiseComplaintsData GetCategoryWiseDashboardData(int userId, string startDate, string endDate, int campaignId, Config.CategoryType categoryType, int categoryId)
        {
            ...
            switch (categoryType)
            {
                case Config.CategoryType.Main:
                    dbUser = RepoDbUsers.GetActiveUser(userId);
                    listDbPermissionsAssignment = RepoDbPermissionsAssignment.GetListOfPermissionsByTypeTypeIdAndPermissionId(
                    ...
                    List<DbDepartment> listDepartment =
                        RepoDbDepartment.GetByCampaignAndGroupId(Utility.GetIntByCommaSepStr(dbUser.Campaigns), null);
                ...
                case Config.CategoryType.Sub:
                    ...
                    listVmUserWiseStatus = new List<VmUserWiseStatus>();
                    groupId =
                        RepoDbCategoryGroupMapping.GetModelByCampaignIdAndTypeId(campaignId,
                            Config.ComplaintType.Complaint);
                    List<DbComplaintType> listComplaintType = RepoDbComplaintType.GetByDepartmentId(categoryId); //DbComplaintType.GetByDepartmentAndGroupId(categoryId, groupId);
                    //List<DbDepartment> listDepartment =
                ...
                case Config.CategoryType.Tertiary:
                    ...
                    groupId =
                        RepoDbCategoryGroupMapping.GetModelByCampaignIdAndTypeId(campaignId,
                            Config.ComplaintType.Complaint);
                    List<DbComplaintSubType> listComplaintSubtType = RepoDbComplaintSubType.GetByComplaintType(categoryId); //DbComplaintType.GetByDepartmentAndGroupId(categoryId, groupId);
                    //List<DbDepartment> listDepartment =
                    //    DbDepartment.GetByCampaignId(Utility.GetIntByCommaSepStr(dbUser.Campaigns));
